 ...
 */
const API_GATEWAY_BASE_URL = process.env.API_GATEWAY_BASE_URL || process.env.API_GATEWAY_URL;
...
const API_URLS = {
  ...
  GITHUB_WEB_BASE_URL: process.env.GITHUB_WEB_BASE_URL,

  // StackOverflow API URLs
  STACKOVERFLOW_API_BASE_URL:
    process.env.STACKOVERFLOW_API_BASE_URL,
